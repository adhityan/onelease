...
<head>
    ...
    <meta name="keywords" content="office, rental, realestate, onelease" />
    <meta name="description" content="Onelease - A one stop solution for office rentals">

    <!-- Title -->
    <title>Onelease - A one stop solution for office rentals</title>
    ...
    <meta itemprop="name" content="Onelease Premium Template">
    ...
    <meta property="og:title" content="Onelease Premium Template"/>
    <meta property="og:description" content="Onelease is an ultra-premium, responsive theme built for todays websites."/>
    <meta property="og:site_name" content="Onelease Premium Template"/>
    -->
    ...
    <meta name="DC.Title" content="Onelease Premium Template, Onelease Responsive Template" />
        ...
        <div class="container siteheader-container">
            ...
            <div class="kl-top-header clearfix">
                ...
                <div class="header-leftside-container ">
                    ...
                    <!-- header contact text -->
                    <span class="kl-header-toptext">QUESTIONS? CALL: <a href="" class="fw-bold">9564753143</a></span>
                    <!--/ header contact text -->
                </div>
                <!--/ HEADER ACTION left -->
            </div>
            ...
            <div class="logo-container hasInfoCard logosize--yes">
                ...
                <h1 class="site-logo logo" id="logo">
                    <a href="/" title="">
                        <img src="images/onelease_logo.png" style="height: 55px;" class="logo-img" alt="Onelease" title="Onelease" />
                    </a>
                </h1>
                <!--/ Logo -->
                        ...
                        <div class="row">
                            <div class="col-sm-5">
                                ...
                                <p style="text-align: center;">
                                    <img src="images/onelease_logo.png" style="height: 55px;" class="" alt="Onelease" title="Onelease" />
                                </p>
                                <p style="text-align: center;">
                                    OneLease is a branded chain of India's finest serviced offices.
                                </p>
                            </div>
                            <!--/ col-sm-5 -->
                            ...
                            <div class="col-sm-7">
                                <div class="custom contact-details">
                                    <p>
                                        <strong>T 9564753143</strong><br>
                                        Email:&nbsp;<a href="mailto:hello@onelease.in">hello@onelease.in</a>
                                    </p>
                                    <p>
                                        Onelease<br>
                                        Shiv Bhagtani Manor, Powai, Mumbai, Mh - 76.
                                    </p>
                                    <a href="https://goo.gl/maps/F7xgGgKKDvx" class="map-link" target="_blank" title="">
                                ...
                                <ul class="social-icons sc--clean">
                                    <li><a href="http://www.facebook.com/oneleasedotin" target="_self" class="icon-twitter" title="Twitter"></a></li>
                                    <li><a href="http://www.twitter.com/onelease" target="_self" class="icon-facebook" title="Facebook"></a></li>
